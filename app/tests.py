...
class TestGetProductFunction(unittest.TestCase):
    def test_get_product(self):
        ...
        self.assertEqual(product[0][3], "AR")  # Третий элемент кортежа содержит подкатегорию продукции
        self.assertEqual(product[0][4], 150000.0)  # Четвертый элемент кортежа содержит цену продукции
